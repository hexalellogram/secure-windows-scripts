...
# New-Item $env:SystemDrive\Mnt -Type Directory | Out-Null
# dism /Mount-Image /ImageFile:D:\sources\install.wim /index:1 /ReadOnly /MountDir:$env:SystemDrive\Mnt
# robocopy /S /SEC /R:0 "$env:SystemDrive\Mnt\Program Files\WindowsApps" "$env:SystemDrive\Program Files\WindowsApps"
# dism /Unmount-Image /Discard /MountDir:$env:SystemDrive\Mnt
# Remove-Item -Path $env:SystemDrive\Mnt -Recurse
